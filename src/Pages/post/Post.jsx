        ...
        <>
            ...
            <main className="row">
                <aside className='order-last order-md-first row justify-content-between mt-1 m-0'>
                    <Link to={`/post/${Previous}`} className={`${classes.btn__move} btn btn-danger`}>قبلی</Link>
                    <Link to={`/post/${Next}`} className={`${classes.btn__move} btn btn-success`}>بعدی</Link>
                </aside>
                        ...
                        <div className={`${classes.cardBody} col-11 col-md-10 row rounded p-3`}>
                            ...
                            <div className='col-12 col-md-3'>
                                <div className={`${classes.title__box} mt-3 mt-md-0`}>
                                    <h2 className={`${classes.heading} col card-heading text-center bold display-2`}>عنوان </h2>
                                ...
                                <div className="row justify-content-center gap-1 mt-3">
                                    <div className="d-inline btn-group text-center">
                                        <button onClick={showFromHandler} type='button' className='btn btn-success w-50'>ویرایش</button>
                                    </div>
                                    <form onSubmit={titleChangeHandler} className={`${classes.title__change} mt-4 ${isActive ? "d-none" : ""}`}>
                                        <h4>عنوان جدید را وارد کنید</h4>
                                        <input className={`${classes.title__input} w-100`} ref={firstRef} type="text" onChange={inputChangeHandler} />
                                        <button onSubmit={titleChangeHandler} className={`${classes.title__button} btn w-100 my-2`} type='submit'>تغییر عنوان</button>
                                    </form>
                                </div>
                            </div>
                        </div>
